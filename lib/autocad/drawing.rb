...
module Autocad
  ...
  class Drawing
    ...
    def create_selection_set(name) #: SelectionSetAdapter
    ...
    # @rbs return void
    def print_pdf(print_path, model: false, plot_config: nil)
      if model
        print_model_space_pdf(print_path, plot_config: plot_config)
        'puts print model'
      else
    ...
    def print_paper_space_pdf(print_path, plot_config:)
      plot_config ||= pdf_plot_config
      plotter = plot
      layout = paper_space_layout
      layout.copy_plot_configuration(plot_config)
    ...
    def print_model_space_pdf(print_path, plot_config:)
      unless plot_config
        default_plot_setup.merge(plot_type: :extents)
        plot_config = add_plot_configuration('model_space_bw')
      end
